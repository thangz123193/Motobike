...
<div class="container">
    <div class="page-header">
        <div class="page-title">Repair orders</div>
    </div>
    ...
    <div class="card">
        <div style="margin-bottom:16px; display:flex; justify-content:space-between; align-items:center;">
            ...
            <a class="btn btn-primary" href="${pageContext.request.contextPath}/admin/create-order">+ New order</a>
        </div>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <table>
                    <thead>
                    <tr><th>ID</th><th>Customer</th><th>Plate</th><th>Technician</th><th>Status</th><th>Total</th><th>Created</th><th></th></tr>
                    </thead>
                    <tbody>
